...
export default function Favbooklist() {
  ...
  const fetchFavoriteBooks = () => {
    axios
      .get("https://book-api-omega.vercel.app/favoritebooks")
      .then((response) => {
  ...
  const handleRemoveFavorite = (id) => {
    axios
      .delete(`https://book-api-omega.vercel.app/favoritebooks/${id}`)
      .then((response) => {
  ...
  const handleSave = (id) => {
    ...
    axios
      .put(`https://book-api-omega.vercel.app/favoritebooks/${id}`, { title, author, amount })
      .then((response) => {
